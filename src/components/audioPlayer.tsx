...
const AudioPlayer = () => {
    return (
        <div className="fixed bottom-0 left-0 z-50 grid w-full h-24 grid-cols-1 px-8 bg-white border-t border-gray-200 md:grid-cols-3  bg-opacity-40 backdrop-blur-xl rounded drop-shadow-lg dark:bg-white-400 dark:border-gray-600">
            <div className="items-center justify-center hidden mr-auto text-gray-500 dark:text-gray-400 md:flex">
                <img
                    className="h-20 mr-3 rounded"
                    src="https://c.saavncdn.com/editorial/charts_CHARTS_SAAVN_hindi_1990s_175982_20230711094900_500x500.jpg"
                    alt="Video preview"
                />
